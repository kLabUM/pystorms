...
ax_1depth.plot(equal_filling_depths.index, equal_filling_depths["('P1', 'depthN')"], label='equal filling', color='blue', alpha=0.5)
ax_1depth.plot(uncontrolled_depths.index, uncontrolled_depths["('P1', 'depthN')"], label='uncontrolled', color='black', alpha=0.5)
ax_1depth.plot(constant_flow_depths.index, constant_flow_depths["('P1', 'depthN')"], label='constant flow', color='green', alpha=0.5)
...
ax_2depth.plot(equal_filling_depths.index, equal_filling_depths["('P2', 'depthN')"], label='equal filling', color='blue', alpha=0.5)
ax_2depth.plot(uncontrolled_depths.index, uncontrolled_depths["('P2', 'depthN')"], label='uncontrolled', color='black', alpha=0.5)
ax_2depth.plot(constant_flow_depths.index, constant_flow_depths["('P2', 'depthN')"], label='constant flow', color='green', alpha=0.5)
# horizontal line at max depth, dotted red
...
ax_1flow.plot(equal_filling_flows.index, equal_filling_flows["1"], label='equal filling', color='blue', alpha=0.5)
ax_1flow.plot(uncontrolled_flows.index, uncontrolled_flows["1"], label='uncontrolled', color='black', alpha=0.5)
ax_1flow.plot(constant_flow_flows.index, constant_flow_flows["1"], label='constant flow', color='green', alpha=0.5)
...
ax_2flows.plot(equal_filling_flows.index, equal_filling_flows["2"], label='equal filling', color='blue', alpha=0.5)
ax_2flows.plot(uncontrolled_flows.index, uncontrolled_flows["2"], label='uncontrolled', color='black', alpha=0.5)
ax_2flows.plot(constant_flow_flows.index, constant_flow_flows["2"], label='constant flow', color='green', alpha=0.5)
ax_2flows.set_ylabel('Flow [m3/s]')
# title
ax_2flows.set_title('Flow out of P2',y=0.8)

# plot flows at 8 (confluence)
ax_8flows.plot(equal_filling_data_log['simulation_time'], equal_filling_data_log['flow']['8'], label='equal filling', color='blue', alpha=0.5)
...
ax_8flows.plot(constant_flow_data_log['simulation_time'], constant_flow_data_log['flow']['8'], label='constant flow', color='green', alpha=0.5)
